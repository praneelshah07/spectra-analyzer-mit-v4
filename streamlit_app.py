...
col1intro, col2intro = st.columns([3.2, 1])  # Adjust column ratio for appropriate spacing
...
with col2intro:
    ...
    st.image('https://raw.githubusercontent.com/praneelshah07/MIT-Project/main/funnycartoon.png', width=300)
